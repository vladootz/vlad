...
<table style="width:600px;">
        <?php
            ...
            if (strnatcmp(phpversion(),'5.6.0') >= 0) {
                ...
                echo '<td class="textno" style="padding-left:10px;">'.phpversion().' <img style="margin-left:10px;" img src="no.png" /> <span style="margin-left:10px;color:black">>= 5.6.0 required</span></td></tr>';
            }
            ...
            echo '<tr><td style="padding-right:10px;" align="right">Mulitbyte string extension:</td>';
            ...
            if(ini_get('display_errors')) {
                ...
                echo '<td class="textoptional" style="padding-left:10px;">Enabled</td></tr>';
            }
